...
- Double horizontal lines separating content headers and blocks.
...
2. Tracked down and removed the overlapping `border-top` / `border-bottom` properties from `.blog-featured` in `overrides.css`.
